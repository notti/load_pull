...
system crashes\cite{ldd}. In opposition to that a kernel module can provide an easy \gls{api} that
...
for active \mbox{\device{outbuf}} (see \cref{sec:digital_processing}). Those dependent properties automatically convert
...
The iterative target algorithm used in this work makes use the following steps:
\begin{enumerate}
