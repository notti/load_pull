...
The design overview, as can be seen in \cref{fig:main_overview}, describes
...
\begin{figure}[htb]
    ...
    \end{subfigure}
    \caption{\device{core} module overview and digital signal processing chain with color coded modules.}
