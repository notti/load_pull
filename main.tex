...
\mbox{\lstinline+inbuf+} for \mbox{\device{inbuf}}, \mbox{\lstinline+H+} for \mbox{\device{H}},
\mbox{\lstinline+out_inactive+} for inactive \mbox{\device{outbuf}}, and \mbox{\lstinline+out_active+}
for active \mbox{\device{outbuf}}. Those dependent properties automatically convert
