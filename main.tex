...
\begin{abstract}
    ...
    using an also realized 1-port vector network analyzer to achieve specific reflection coefficients was
    developed. This algorithm needs no calibration and allows verifying highly non-linear devices
...
\begin{abstract}
    Load-pull ist ein nicht lineare Messtechnik, bei der Messungen durchgeführt
    werden, indem verschiedene Impedanzen an ein zu prüfendes Objekt angelegt
    werden. Aktive load-pull Systeme lösen diese Aufgabe mit zurückschicken einer
    ...
    Traditionelle load-pull Messsysteme können nur schmalbandige Signale verarbeiten.
    ...
    erzielt. Die Filterung ermöglicht ausgleichen der Gruppenlaufzeit verursacht
    von den Kabel im Messaufbau eines periodischen Signals. Dies wird erreicht, indem die Phase
    des reflektierten Signals an die Phase des Ausgangssignals einer zukünftigen Signalperiode
    angeglichen wird. Weiters wurde ein iterativer Algorithmus entworfen, der, basierend
    auf Messungen eines zusätzlich implementierten Netzwerkanalysators, den gewünschten
    Reflexionskoeffizienten erreichen kann. Dies wird benötigt um Prüfobjekte
