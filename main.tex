...
The embedded processor design was realized with the Xilinx Platform
Studio. This design consists of every additional module needed to be
...
\begin{itemize}
    \item describe plb interface \cite{slave_burst,ppc} (burst!)
\end{itemize}
