...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        ...
        \draw[dashed] (box-1-2) -- ++(0,1.5cm) node[anchor=south] {Load Reference Plane};
        \draw[dashed] (box-1-3) -- ++(0,1.5cm) node[anchor=south] {Oscilloscope};
...
consits of the \gls{dut} and an error box, containing all the systematic errors of the measurement
