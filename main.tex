...
\begin{lstlisting}[float=htb,language=C,caption={Basic elements of a platform driver module},label=src:pdriver,basicstyle=\hack\tiny]
...
...
\lstset{language=C,escapeinside={<*}{*>}}
\begin{lstlisting}[float=htbp,language=C,caption={Character device},label=src:cdev,basicstyle=\hack\tiny]
