...
The \device{inbuf} module is fully runtime configureable. Changing the active receiver
...
the source. The memory interface of the inbuf module has a \SI{16}{\bit} wide data bus,
a \SI{16}{\bit} wide address bus and a read access time of 2 cycles. Accessing samples
