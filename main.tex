...
multiplier features a bit shifter at the output. This bit shifter divides the
...
and convergent rounding, this multiplier also features dynamic configurable
saturation.
...
\begin{itemize}
    \item describe digital iq interface\cite{fsq_b17,ds90cr485} \cref{fig:trans}
\end{itemize}
