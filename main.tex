...
\begin{abstract}
    ...
    um gewünschte Reflexionskoeffizienten erzeugen zu können, auch für
    Prüfobjekte die lastabhängiges Verhalten zeigen.
    ...
    der digitalen Hardware mittels Ethernet ermöglicht.

    Abschliessend wurde das Messsystem mit einem kommerziell verfügbaren vektoriellen
    Netzwerkanalysator anstelle eines Prüfobjekts getestet.
\end{abstract}
\end{otherlanguage}
