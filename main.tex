...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}
        \begin{smithchart}[width=7cm,clip=false]
            ...
            \addplot[red,is smithchart cs,mark=*,only marks] coordinates {(-0.3536,03536)};
        \end{smithchart}
    \end{tikzpicture}\\
    \begin{tikzpicture}
        \begin{smithchart}[width=7cm,clip=false]
    ...
    \begin{tikzpicture}
        \begin{smithchart}[width=7cm,clip=false]
            ...
            \addplot[red,is smithchart cs,mark=*,only marks] coordinates {(0.3536,-03536) (-0.3536,03536)};
        \end{smithchart}
    \end{tikzpicture}
