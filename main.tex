...
the \device{probe} and \device{remove} functions (\cref{probe,remove}). The \device{probe} function
...
released in the \device{remove} function. Omitting this prevents reloading the driver.
