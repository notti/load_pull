...
filter out the aliases (see \cref{sec:digital}). The digital reflection generation introduces
...
\cref{sec:digital}). Filter calibration was then carried out at the following $\Gamma_L$
