...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}[every node/.style={minimum width=5em},latex-latex]
        ...
        \node[coordinate] at ($(internal) + (0,4.5em)$) (r) {};
        \foreach \i in {1,...,4}
        {
        ...
        \node[draw,fit=(internal-1-1) (internal-4-1) (l) (r),inner xsep=0.5em] (main) {};
        \node[draw,fit=(cpu) (peripherals-5-2) (plb) (main),inner xsep=0.5em] (fpga) {};
        \node[anchor=north east,minimum width=0] at (fpga.north east) {top};
        \node[anchor=north east,minimum width=0] at (main.north east) {main};
