...
Therefore, an iterative approach is needed to achieve a specific $\gls{GammaL}$ \cite{muller_comparison_1994}.
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[c]{.48\linewidth}
        \centering
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0pt] (image) at (0,0) {\includegraphics[width=\linewidth]{adc.jpg}};
    ...
    \begin{subfigure}[c]{.48\linewidth}
        \centering
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=\linewidth]{digital_iq.jpg}};
        \end{tikzpicture}
