...
\gls{cpu}. Linux was chosen as the \gls{os} for the \device{processor} module, because
...
the internal modules is active. Further module activations are also not possible
...
A description of a Linux kernel module implementation operating this interface
