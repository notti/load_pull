...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \end{smithchart}
        \end{tikzpicture}
        \caption{Passive \glsentryshort{lp} system}
        \label{fig:range_passive}
    \end{subfigure}
    \caption{Generic representation of achievable tuning range/points passive \glsentryshort{lp}}
\end{figure}
...
It was specifically tailored to a Xilinx Virtex-5 FXT on a ML507 evaluation board.
