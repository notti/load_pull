...
\pgfdeclareshape{circulator}
{
    ...
    \backgroundpath{			
        ...
        \pgfscope
            ...
            \pgfpathcircle{\pgfpoint{0}{0}}{\pgf@circ@res@other}
            \pgfusepath{draw}
        \endpgfscope
        \pgfscope
            \pgfsetarrowsend{Latex[length=2pt]}
            \pgfpathmoveto{\pgfpoint{-0.65\pgf@circ@res@other}{0}}
            \pgfpatharc{180}{0} {0.65\pgf@circ@res@other}
            \pgfusepath{draw}
        \endpgfscope
        \pgfpathmoveto{\pgfpoint{\pgf@circ@res@left}{0pt}}
...
\pgfdeclareshape{vectorgenerator}
{
    ...
    \backgroundpath{			
        ...
        \pgfscope
            ...
            \pgftransformscale{.3}
            \pgftransformrotate{180}
            \pgfnode{dac}{center}{}{pgf@dac}{\pgfusepath{stroke}}
        \endpgfscope
